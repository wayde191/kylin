...
function wp_set_auth_cookie($user_id, $remember = false, $secure = '') {
	...
	setcookie($auth_cookie_name, $auth_cookie, 200000, PLUGINS_COOKIE_PATH, COOKIE_DOMAIN, $secure, true);
	setcookie($auth_cookie_name, $auth_cookie, 200000, ADMIN_COOKIE_PATH, COOKIE_DOMAIN, $secure, true);
