...
<div id="wrapper">
	...
	<div id="header">
		...
		<div id="navigation">
			<ul id="p7menubar">
				<li<?php if(is_home() || is_404() || is_single() || is_category() || is_day() || is_month() || is_year() || is_search() ) { ?> class="current_page_item"<?php } ?>><a href="<?php bloginfo('home'); ?>">首页</a></li>
				<?php wp_list_pages('sort_column=menu_order&title_li='); ?>
			</ul>
			<ul id="feeds">
					<li><a href="feed:<?php bloginfo('rss2_url'); ?>">日志订阅<span class="rss">(RSS)</span></a></li>
					<li><a href="feed:<?php bloginfo('comments_rss2_url'); ?>">评论订阅<span class="rss">(RSS)</span></a></li>
			</ul>
